  ...
  ngOnInit(): void {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      ...
      creditCard: this.formBuilder.group({
        ...
        cardNumber: new FormControl('', [Validators.required, Validators.pattern('[0-9]{16}'), EShopValidators.notOnlyWhitespace]),
        securityCode: new FormControl('', [Validators.required, Validators.pattern('[0-9]{3}'), EShopValidators.notOnlyWhitespace]),
        expirationMonth: [''],
        expirationYear: ['']
      }),
